    ...
    public partial class CreatDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.tb_ProductDetail", t => t.ProductDetailId, cascadeDelete: true)
                .Index(t => t.OrderId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.tb_Sizes", t => t.Size_ID)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_ProductDetail", "SizeId", "dbo.tb_Sizes");
            ...
            DropForeignKey("dbo.tb_OrderDetail", "ProductDetailId", "dbo.tb_ProductDetail");
            ...
            DropIndex("dbo.tb_ProductDetail", new[] { "SizeId" });
            DropIndex("dbo.tb_ProductDetail", new[] { "ProductId" });
            DropIndex("dbo.tb_OrderDetail", new[] { "ProductDetailId" });
